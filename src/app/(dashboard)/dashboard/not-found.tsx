...
import { Home, ArrowLeft, LayoutDashboard, Users } from "lucide-react";

export default function DashboardNotFound() {
  return (
    <html lang="en">
      <head>
        <title>Dashboard Page Not Found - YourApp</title>
        <meta name="description" content="The dashboard page you're looking for doesn't exist." />
      </head>
